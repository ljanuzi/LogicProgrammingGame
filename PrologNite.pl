...
%find  neighbouring position on the board upwards from left to right
nextpos(diagonalUpRight,XPos,YPos,NextPosX,NextPosY):-
	NextPosX is XPos + 1,
	NextPosX < 6,
	NextPosY is YPos + 1,
	NextPosY < 6.

%find  neighbouring position on the board downwards from right to left
nextpos(diagonalDownLeft, XPos, YPos, NextPosX, NextPosY):-
	NextPosX is XPos - 1,
	NextPosX > 0,
	NextPosY is YPos - 1,
	NextPosY > 0.

%find  neighbouring position on the board upwards from right to left
nextpos(diagonalUpLeft, XPos, YPos, NextPosX, NextPosY):-
	NextPosX is XPos - 1,
	NextPosX > 0,
	NextPosY is YPos + 1,
	NextPosY < 6.

%find  neighbouring position on the board downwards from left to right
nextpos(diagonalDownRight, XPos, YPos, NextPosX, NextPosY):-
	NextPosX is XPos + 1,
	NextPosX < 6,
	NextPosY is YPos - 1,
	NextPosY > 0.
...
sumList([(_,_,_,N)|T],Sum):-
	sumList(T,TailSum),
	Sum is TailSum + N.

outnumber(List,Value):-
	sumList(List,S),
	Value < S.
/*--------------------------------------------------------------------------
